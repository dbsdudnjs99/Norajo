...
const TodoList = () => {
    ...
    const addTodo = () => {
        ...
        //   completed: 완료 여부,
        // }
        // ...todos => {id: 1, text: "할일1", due: "", completed: false}, {id: 2, text: "할일2", due: "", completed: false}}, ..
        setTodos([...todos, { id: Date.now(), text: input, due: dueDate, completed: false}]);
        setInput("");
        setDueDate("");
    };
    ...
    return (
        <div className={styles.container}>
            ...
            {/* 할 일을 추가하는 버튼입니다. */}
            <button className="w-40 justify-self-end p-1 mb-4 bg-blue-500 text-white border border-blue-500 rounded hover:bg-white hover:text-blue-500"
             onClick={addTodo}>
                Add Todo
            </button>
